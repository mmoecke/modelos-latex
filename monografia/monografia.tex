...
%---------------------------------------------------------------------%
%---------------------------------------------------------------------%
% Informações de dados para CAPA e FOLHA DE ROSTO E LOMBADA
%---------------------------------------------------------------------%
%---------------------------------------------------------------------%
...
% Desenvolver uma folha de lombada
% Deixar um espaço de 30 mm na borda inferior para a colocação de elementos de identificação que possibilitem a localização do documento.
% Na lombada devem constar: nome do autor, impresso longitudinalmente e legível do alto para o pé da lombada (esta forma possibilita a leitura quando o trabalho está no sentido horizontal, com a face voltada para cima); título do trabalho, impresso da mesma forma que o nome do autor;
%\imprimirlombada
